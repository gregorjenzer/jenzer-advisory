              ...
              <div className="flex flex-col justify-center space-y-6 reveal">
                ...
                <div className="flex flex-col sm:flex-row gap-5 pt-8">
                  ...
                  <Button
                    ...
                    size="lg"
                    asChild
                    className="border-white text-white hover:bg-white/10 font-medium w-full sm:w-auto mt-2 sm:mt-0 btn-outline-on-dark"
                  >
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
              <div className="flex flex-col justify-center space-y-6 reveal">
                ...
                <div className="flex flex-col gap-3 min-[400px]:flex-row pt-4">
                  <Button variant="outline" asChild className="btn-outline-on-dark">
